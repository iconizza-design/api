import { defaultIconDimensions, flipFromString, iconToHTML, iconToSVG, rotateFromString } from '@iconizza/utils';
import { defaultIconCustomisations, IconizzaIconCustomisations } from '@iconizza/utils/lib/customisations/defaults';
