...
export type APIv2CollectionsResponse = Record<string, IconizzaInfo>;
...
export interface APIv2CollectionResponse {
	...
	// Themes
	themes?: IconizzaJSON['themes']; // Deprecated, so it can be ignored
	prefixes?: IconizzaJSON['prefixes'];
	suffixes?: IconizzaJSON['suffixes'];
}
...
export interface APIv2SearchResponse {
	...
	collections: Record<string, IconizzaInfo>;
