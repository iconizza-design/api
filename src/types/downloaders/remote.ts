import type { GitHubAPIOptions } from '@iconizza/tools/lib/download/github/types';
import type { GitLabAPIOptions } from '@iconizza/tools/lib/download/gitlab/types';
import type { NPMPackageOptions } from '@iconizza/tools/lib/download/npm/types';
import type { DownloadGitRepoResult } from '@iconizza/tools/lib/download/git';
import type { DownloadGitHubRepoResult } from '@iconizza/tools/lib/download/github';
import type { DownloadGitLabRepoResult } from '@iconizza/tools/lib/download/gitlab';
