import type { IconizzaAliases, IconizzaJSON, IconizzaOptional } from '@iconizza/types';
...
const customisableProps = Object.keys(defaultIconProps) as (keyof IconizzaOptional)[];

/**
 * Generate icons tree
 */
export function generateIconSetIconsTree(iconSet: IconizzaJSON, commonChunks?: string[]): IconSetIconsListIcons {
	const iconSetIcons = iconSet.icons;
	const iconSetAliases = iconSet.aliases || (Object.create(null) as IconizzaAliases);
